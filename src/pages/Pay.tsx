      ...
      <div className="flex justify-center items-center">
        <div>
          ...
          <img src={qrCode} alt="" />
            ...
            <br />
            {minutes === 0 && seconds === 0 ? (
              <button className="relative left-[33%]"
                      disabled={true}
              >
                Time ran out
              </button>
            ) : (
              <button className="relative left-[28%] bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                Finished Paying
              </button>
            )}
        </div>
